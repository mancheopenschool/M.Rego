...
$pyjs['loaded_modules']['math'] = function (__mod_name__) {
	...
	return $collcomp1;}();
		...
		$m['hypot'] = function(x, y) {
			...
			$pyjs['track']['lineno']=61;
			var $pyjs__ret = (typeof ($mul9=x)==typeof ($mul10=$m['sqrt']($p['__op_add']($add5=$constant_int_1,$add6=(typeof ($mul7=(typeof ($div11=y)==typeof ($div12=x) && typeof $div11=='number' && $div12 !== 0?
				$div11/$div12:
