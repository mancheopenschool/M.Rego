...
$pyjs['loaded_modules']['pyjamas.Location'] = function (__mod_name__) {
	...
	try {
		...
		$m.__track_lines__[18] = 'pyjamas.Location.py, line 18:\n    class Location:';
		...
		$m.__track_lines__[30] = 'pyjamas.Location.py, line 30:\n    def getHash(self):';
		$m.__track_lines__[31] = 'pyjamas.Location.py, line 31:\n    return self.location.hash';
		...
		$m.__track_lines__[66] = 'pyjamas.Location.py, line 66:\n    def getSearch(self):';
		$m.__track_lines__[67] = 'pyjamas.Location.py, line 67:\n    return self.location.search or ""';
		...
		$m['Location'] = (function(){
			...
			$cls_definition['__md5__'] = 'c2187f250771588d43065a6ff4913fbf';
			...
			$method = $pyjs__bind_method2('__init__', function(location) {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'c2187f250771588d43065a6ff4913fbf') {
	...
	, 1, [null,null,['self'],['location']]);
			...
			$method = $pyjs__bind_method2('getHash', function() {
				...
				$pyjs['track']['lineno']=31;
				var $pyjs__ret = $p['getattr']($p['getattr'](self, 'location'), 'hash');
				$pyjs['trackstack']['pop']();$pyjs['track']=$pyjs['trackstack']['pop']();$pyjs['trackstack']['push']($pyjs['track']);
				return $pyjs__ret;
			}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('getSearch', function() {
				...
				$pyjs['track']['lineno']=67;
				var $pyjs__ret = ($p['bool']($or3=$p['getattr']($p['getattr'](self, 'location'), 'search'))?$or3:'');
				$pyjs['trackstack']['pop']();$pyjs['track']=$pyjs['trackstack']['pop']();$pyjs['trackstack']['push']($pyjs['track']);
				return $pyjs__ret;
			}
	, 1, [null,null,['self']]);
