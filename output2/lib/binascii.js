...
$pyjs['loaded_modules']['binascii'] = function (__mod_name__) {
	...
	try {
		...
		$m['a2b_uu'] = function(s) {
			...
			length = (typeof ($mod1=$p['__op_sub']($sub1=$p['ord'](s['__getitem__']($constant_int_0)),$sub2=$constant_int_32))==typeof ($mod2=$constant_int_64) && typeof $mod1=='number'?
			...
			quadruplets_gen = function(s) {
				...
				while ($p['bool'](s)) {
					...
					try {
						...
						iterlist['append']($p['tuple']([$p['ord'](s['__getitem__']($constant_int_0)), $p['ord'](s['__getitem__']($constant_int_1)), $p['ord'](s['__getitem__']($constant_int_2)), $p['ord'](s['__getitem__']($constant_int_3))]));
					} catch($pyjs_try_err) {
	...
	$collcomp1 = $p['list']();
				...
				while (typeof($p['__wrapped_next']($iter1_nextval)['$nextval']) != 'undefined') {
					var $tupleassign1 = $p['__ass_unpack']($iter1_nextval['$nextval'], 4, null);
					A = $tupleassign1[0];
					B = $tupleassign1[1];
					C = $tupleassign1[2];
					D = $tupleassign1[3];
					$collcomp1['append'](''['join']($p['list']([$p['chr']($p['op_bitor2']($p['op_bitshiftleft']($p['__op_sub']($sub3=A,$sub4=$constant_int_32),$constant_int_2), $p['op_bitand2']($p['op_bitshiftright']($p['__op_sub']($sub5=B,$sub6=$constant_int_32),$constant_int_4), $constant_int_3))), $p['chr']($p['op_bitor2']($p['op_bitshiftleft']($p['op_bitand2']($p['__op_sub']($sub7=B,$sub8=$constant_int_32), $constant_int_15),$constant_int_4), $p['op_bitand2']($p['op_bitshiftright']($p['__op_sub']($sub9=C,$sub10=$constant_int_32),$constant_int_2), $constant_int_15))), $p['chr']($p['op_bitor2']($p['op_bitshiftleft']($p['op_bitand2']($p['__op_sub']($sub11=C,$sub12=$constant_int_32), $constant_int_3),$constant_int_6), $p['op_bitand2']($p['__op_sub']($sub13=D,$sub14=$constant_int_32), $constant_int_63)))])));
				}
	...
	return $collcomp1;}();
		...
		$m['b2a_uu'] = function(s) {
			...
			if ($p['bool'](($p['cmp'](length, $constant_int_45) == 1))) {
			...
			triples_gen = function(s) {
				...
				while ($p['bool'](s)) {
					...
					try {
						...
						iterlist['append']($p['tuple']([$p['ord'](s['__getitem__']($constant_int_0)), $p['ord'](s['__getitem__']($constant_int_1)), $p['ord'](s['__getitem__']($constant_int_2))]));
					} catch($pyjs_try_err) {
						$pyjs['__last_exception_stack__'] = sys['save_exception_stack']($pyjs__trackstack_size_1 - 1);
						$pyjs['__active_exception_stack__'] = null;
						$pyjs_try_err = $p['_errorMapping']($pyjs_try_err);
	...
	$collcomp2 = $p['list']();
			...
			while (typeof($p['__wrapped_next']($iter2_nextval)['$nextval']) != 'undefined') {
				var $tupleassign2 = $p['__ass_unpack']($iter2_nextval['$nextval'], 3, null);
				A = $tupleassign2[0];
				B = $tupleassign2[1];
				C = $tupleassign2[2];
				$collcomp2['append'](''['join']($p['list']([$p['chr']($p['__op_add']($add7=$constant_int_32,$add8=$p['op_bitand2']($p['op_bitshiftright'](A,$constant_int_2), $constant_int_63))), $p['chr']($p['__op_add']($add9=$constant_int_32,$add10=$p['op_bitand2']($p['op_bitor2']($p['op_bitshiftleft'](A,$constant_int_4), $p['op_bitand2']($p['op_bitshiftright'](B,$constant_int_4), $constant_int_15)), $constant_int_63))), $p['chr']($p['__op_add']($add11=$constant_int_32,$add12=$p['op_bitand2']($p['op_bitor2']($p['op_bitshiftleft'](B,$constant_int_2), $p['op_bitand2']($p['op_bitshiftright'](C,$constant_int_6), $constant_int_3)), $constant_int_63))), $p['chr']($p['__op_add']($add13=$constant_int_32,$add14=$p['op_bitand2'](C, $constant_int_63)))])));
			}
			if ($pyjs['trackstack']['length'] > $pyjs__trackstack_size_1) {
				$pyjs['trackstack'] = $pyjs['trackstack']['slice'](0,$pyjs__trackstack_size_1);
				$pyjs['track'] = $pyjs['trackstack']['slice'](-1)[0];
	...
	return $collcomp2;}();
			...
			$pyjs['track']['lineno']=89;
			var $pyjs__ret = $p['__op_add']($add19=$p['__op_add']($add17=$p['chr']($p['__op_add']($add15=$p['ord'](' '),$add16=$p['op_bitand2'](length, $constant_int_63))),$add18=''['join'](result)),$add20='\n');
			$pyjs['trackstack']['pop']();$pyjs['track']=$pyjs['trackstack']['pop']();$pyjs['trackstack']['push']($pyjs['track']);
			return $pyjs__ret;
		};
		...
		$m['a2b_base64'] = function(s) {
			...
			next_valid_char = function(s, pos) {
				...
				$pyjs__trackstack_size_1=$pyjs['trackstack']['length'];
				$iter3_iter = $p['range']($p['__op_add']($add21=pos,$add22=$constant_int_1), $p['len'](s));
			...
			while (typeof($p['__wrapped_next']($iter4_nextval)['$nextval']) != 'undefined') {
				...
				if ($p['bool'](($p['bool']($or1=($p['cmp'](c, '\x7f') == 1))?$or1:($p['bool']($or2=$p['op_eq'](c, '\n'))?$or2:($p['bool']($or3=$p['op_eq'](c, '\r'))?$or3:$p['op_eq'](c, ' ')))))) {
				...
				if ($p['bool']($p['op_eq'](c, '='))) {
					...
					if ($p['bool'](($p['bool']($or5=($p['cmp'](quad_pos, $constant_int_2) == -1))?$or5:($p['bool']($and1=$p['op_eq'](quad_pos, $constant_int_2))?!$p['op_eq'](next_valid_char(s, i), '='):$and1)))) {
				...
				if ($p['bool'](((($p['cmp'](leftbits, $constant_int_8))|1) == 1))) {
			...
			if ($p['bool'](!$p['op_eq'](leftbits, $constant_int_0))) {
	...
	return $collcomp3;}());
		...
		$m['b2a_base64'] = function(s) {
			...
			a = triples_gen($p['__getslice'](s, 0, $p['__op_sub']($sub21=length,$sub22=final_length)));
	...
	return $collcomp4;}();
			...
			if ($p['bool']($p['op_eq'](final_length, $constant_int_0))) {
				$pyjs['track']['lineno']=249;
				snippet = '';
			}
			else if ($p['bool']($p['op_eq'](final_length, $constant_int_1))) {
				$pyjs['track']['lineno']=251;
				a = $p['ord']($$final['__getitem__']($constant_int_0));
				...
				b = $p['ord']($$final['__getitem__']($constant_int_1));
			...
			$pyjs['track']['lineno']=260;
			var $pyjs__ret = $p['__op_add']($add41=$p['__op_add']($add39=''['join'](result),$add40=snippet),$add42='\n');
			$pyjs['trackstack']['pop']();$pyjs['track']=$pyjs['trackstack']['pop']();$pyjs['trackstack']['push']($pyjs['track']);
			return $pyjs__ret;
		};
		...
		$m['a2b_qp'] = function(s, header) {
			...
			while ($p['bool'](($p['cmp'](inp, $p['len'](s)) == -1))) {
				...
				if ($p['bool']($p['op_eq'](s['__getitem__'](inp), '='))) {
					...
					if ($p['bool'](($p['bool']($or7=$p['op_eq'](s['__getitem__'](inp), '\n'))?$or7:$p['op_eq'](s['__getitem__'](inp), '\r')))) {
						$pyjs['track']['lineno']=272;
						if ($p['bool'](!$p['op_eq'](s['__getitem__'](inp), '\n'))) {
							$pyjs['track']['lineno']=273;
							while ($p['bool'](($p['bool']($and3=($p['cmp'](inp, $p['len'](s)) == -1))?!$p['op_eq'](s['__getitem__'](inp), '\n'):$and3))) {
					...
					else if ($p['bool'](($p['bool']($and5=(typeof hex_numbers == "undefined"?$m['hex_numbers']:hex_numbers)['__contains__'](s['__getitem__'](inp)))?(typeof hex_numbers == "undefined"?$m['hex_numbers']:hex_numbers)['__contains__'](s['__getitem__']($p['__op_add']($add51=inp,$add52=$constant_int_1))):$and5))) {
						$pyjs['track']['lineno']=282;
						ch = $p['chr']($p['int']($p['__getslice'](s, inp, $p['__op_add']($add53=inp,$add54=$constant_int_2)), $constant_int_16));
		...
		$m['b2a_qp'] = function(data, quotetabs, istext, header) {
			...
			while ($p['bool'](($p['cmp'](inp, $p['len'](data)) == -1))) {
				...
				if ($p['bool'](($p['bool']($or16=($p['cmp'](c, '~') == 1))?$or16:($p['bool']($or17=$p['op_eq'](c, '='))?$or17:($p['bool']($or18=($p['bool']($and11=header)?$p['op_eq'](c, '_'):$and11))?$or18:($p['bool']($or19=($p['bool']($and13=$p['op_eq'](c, '.'))?($p['bool']($and14=$p['op_eq'](linelen, $constant_int_0))?($p['bool']($or9=$p['op_eq'](inp, $p['len'](data)))?$or9:($p['bool']($or10=$p['op_eq'](data['__getitem__']($p['__op_add']($add61=inp,$add62=$constant_int_1)), '\n'))?$or10:$p['op_eq'](data['__getitem__']($p['__op_add']($add63=inp,$add64=$constant_int_1)), '\r'))):$and14):$and13))?$or19:($p['bool']($or20=($p['bool']($and16=!$p['bool'](istext))?($p['bool']($or12=$p['op_eq'](c, '\r'))?$or12:$p['op_eq'](c, '\n')):$and16))?$or20:($p['bool']($or21=($p['bool']($and18=($p['bool']($or14=$p['op_eq'](c, '\t'))?$or14:$p['op_eq'](c, ' ')))?$p['op_eq']($p['__op_add']($add65=inp,$add66=$constant_int_1), $p['len'](data)):$and18))?$or21:($p['bool']($and20=($p['cmp'](c, ' ') < 1))?($p['bool']($and21=!$p['op_eq'](c, '\r'))?($p['bool']($and22=!$p['op_eq'](c, '\n'))?($p['bool']($or23=quotetabs)?$or23:($p['bool']($and24=!$p['bool'](quotetabs))?($p['bool']($and26=!$p['op_eq'](c, '\t'))?!$p['op_eq'](c, ' '):$and26):$and24)):$and22):$and21):$and20))))))))) {
					...
					if ($p['bool'](($p['bool']($and28=istext)?($p['bool']($or25=$p['op_eq'](c, '\n'))?$or25:($p['bool']($and30=($p['cmp']($p['__op_add']($add73=inp,$add74=$constant_int_1), $p['len'](data)) == -1))?($p['bool']($and31=$p['op_eq'](c, '\r'))?$p['op_eq'](data['__getitem__']($p['__op_add']($add75=inp,$add76=$constant_int_1)), '\n'):$and31):$and30)):$and28))) {
						$pyjs['track']['lineno']=335;
						linelen = $constant_int_0;
						$pyjs['track']['lineno']=337;
						if ($p['bool'](($p['bool']($and33=($p['cmp']($p['len'](odata), $constant_int_0) == 1))?($p['bool']($or27=$p['op_eq'](odata['__getitem__']((typeof ($usub1=$constant_int_1)=='number'?
							-$usub1:
							...
							ch = $p['ord'](odata['__getitem__']((typeof ($usub3=$constant_int_1)=='number'?
								-$usub3:
								$p['op_usub']($usub3))));
						...
						if ($p['bool'](($p['bool']($and35=($p['cmp']($p['__op_add']($add81=inp,$add82=$constant_int_1), $p['len'](data)) == -1))?($p['bool']($and36=!$p['op_eq'](data['__getitem__']($p['__op_add']($add83=inp,$add84=$constant_int_1)), '\n'))?((($p['cmp']($p['__op_add']($add85=linelen,$add86=$constant_int_1), MAXLINESIZE))|1) == 1):$and36):$and35))) {
		...
		$m['hex'] = function(n) {
			...
			if ($p['bool']($p['op_eq'](n, $constant_int_0))) {
			...
			$pyjs['track']['lineno']=390;
			var $pyjs__ret = $p['__op_add']($add93=sign,$add94=''['join'](arr));
			$pyjs['trackstack']['pop']();$pyjs['track']=$pyjs['trackstack']['pop']();$pyjs['trackstack']['push']($pyjs['track']);
			return $pyjs__ret;
		};
		$m['hex']['__name__'] = 'hex';
		...
		$m['a2b_hqx'] = function(s) {
			...
			quadruples_gen = function(s) {
				...
				while (typeof($p['__wrapped_next']($iter9_nextval)['$nextval']) != 'undefined') {
					...
					if ($p['bool']($p['op_eq']($p['len'](t), $constant_int_4))) {
			...
			try {
				...
				while (typeof($p['__wrapped_next']($iter10_nextval)['$nextval']) != 'undefined') {
					...
					if ($p['bool']($p['op_eq'](length, $constant_int_4))) {
						$pyjs['track']['lineno']=504;
						result['append']($p['chr']($p['op_bitor2']($p['op_bitshiftleft']($p['op_bitand2'](snippet['__getitem__']($constant_int_0), $constant_int_63),$constant_int_2), $p['op_bitshiftright'](snippet['__getitem__']($constant_int_1),$constant_int_4))));
						$pyjs['track']['lineno']=505;
						result['append']($p['chr']($p['op_bitor2']($p['op_bitshiftleft']($p['op_bitand2'](snippet['__getitem__']($constant_int_1), $constant_int_15),$constant_int_4), $p['op_bitshiftright'](snippet['__getitem__']($constant_int_2),$constant_int_2))));
						$pyjs['track']['lineno']=506;
						result['append']($p['chr']($p['op_bitor2']($p['op_bitshiftleft']($p['op_bitand2'](snippet['__getitem__']($constant_int_2), $constant_int_3),$constant_int_6), snippet['__getitem__']($constant_int_3))));
					}
					else if ($p['bool']($p['op_eq'](length, $constant_int_3))) {
						$pyjs['track']['lineno']=508;
						result['append']($p['chr']($p['op_bitor2']($p['op_bitshiftleft']($p['op_bitand2'](snippet['__getitem__']($constant_int_0), $constant_int_63),$constant_int_2), $p['op_bitshiftright'](snippet['__getitem__']($constant_int_1),$constant_int_4))));
						$pyjs['track']['lineno']=509;
						result['append']($p['chr']($p['op_bitor2']($p['op_bitshiftleft']($p['op_bitand2'](snippet['__getitem__']($constant_int_1), $constant_int_15),$constant_int_4), $p['op_bitshiftright'](snippet['__getitem__']($constant_int_2),$constant_int_2))));
					}
					else if ($p['bool']($p['op_eq'](length, $constant_int_2))) {
		...
		$m['b2a_hqx'] = function(s) {
					...
					try {
						...
						if (($pyjs_try_err_name == $p['IndexError']['__name__'])||$p['_isinstance']($pyjs_try_err,$p['IndexError'])) {
							...
							try {
								...
								iterlist['append']($p['tuple']([$p['ord'](s['__getitem__']($constant_int_0)), $p['ord'](s['__getitem__']($constant_int_1))]));
							} catch($pyjs_try_err) {
								...
								if (($pyjs_try_err_name == $p['IndexError']['__name__'])||$p['_isinstance']($pyjs_try_err,$p['IndexError'])) {
									...
									iterlist['append']($p['tuple']([$p['ord'](s['__getitem__']($constant_int_0))]));
								} else { $pyjs['__active_exception_stack__'] = $pyjs['__last_exception_stack__']; $pyjs['__last_exception_stack__'] = null; throw $pyjs_try_err; }
							}
						} else { $pyjs['__active_exception_stack__'] = $pyjs['__last_exception_stack__']; $pyjs['__last_exception_stack__'] = null; throw $pyjs_try_err; }
					}
			...
			while (typeof($p['__wrapped_next']($iter11_nextval)['$nextval']) != 'undefined') {
				...
				if ($p['bool']($p['op_eq'](length, $constant_int_3))) {
					$pyjs['track']['lineno']=544;
					result['append']($m['hqx_encoding']['__getitem__']($p['op_bitshiftright']($p['op_bitand2'](snippet['__getitem__']($constant_int_0), $constant_int_252),$constant_int_2)));
					$pyjs['track']['lineno']=545;
					result['append']($m['hqx_encoding']['__getitem__']($p['op_bitor2']($p['op_bitshiftleft']($p['op_bitand2'](snippet['__getitem__']($constant_int_0), $constant_int_3),$constant_int_4), $p['op_bitshiftright']($p['op_bitand2'](snippet['__getitem__']($constant_int_1), $constant_int_240),$constant_int_4))));
					$pyjs['track']['lineno']=547;
					result['append']($m['hqx_encoding']['__getitem__']($p['op_bitor2']($p['op_bitshiftleft']($p['op_bitand2'](snippet['__getitem__']($constant_int_1), $constant_int_15),$constant_int_2), $p['op_bitshiftright']($p['op_bitand2'](snippet['__getitem__']($constant_int_2), $constant_int_192),$constant_int_6))));
					$pyjs['track']['lineno']=549;
					result['append']($m['hqx_encoding']['__getitem__']($p['op_bitand2'](snippet['__getitem__']($constant_int_2), $constant_int_63)));
				}
				else if ($p['bool']($p['op_eq'](length, $constant_int_2))) {
					...
					result['append']($m['hqx_encoding']['__getitem__']($p['op_bitshiftleft']($p['op_bitand2'](snippet['__getitem__']($constant_int_1), $constant_int_15),$constant_int_2)));
				}
				else if ($p['bool']($p['op_eq'](length, $constant_int_1))) {
					$pyjs['track']['lineno']=559;
					result['append']($m['hqx_encoding']['__getitem__']($p['op_bitshiftright']($p['op_bitand2'](snippet['__getitem__']($constant_int_0), $constant_int_252),$constant_int_2)));
					$pyjs['track']['lineno']=560;
					result['append']($m['hqx_encoding']['__getitem__']($p['op_bitshiftleft']($p['op_bitand2'](snippet['__getitem__']($constant_int_0), $constant_int_3),$constant_int_4)));
				}
			}
			if ($pyjs['trackstack']['length'] > $pyjs__trackstack_size_1) {
				$pyjs['trackstack'] = $pyjs['trackstack']['slice'](0,$pyjs__trackstack_size_1);
		...
		$m['crc_hqx'] = function(s, crc) {
			...
			while (typeof($p['__wrapped_next']($iter12_nextval)['$nextval']) != 'undefined') {
				...
				crc = $p['op_bitxor2']($p['op_bitand2']($p['op_bitshiftleft'](crc,$constant_int_8), $constant_int_65280), $m['crctab_hqx']['__getitem__']($p['op_bitxor2']($p['op_bitand2']($p['op_bitshiftright'](crc,$constant_int_8), $constant_int_255), $p['ord'](c))));
			}
			if ($pyjs['trackstack']['length'] > $pyjs__trackstack_size_1) {
				$pyjs['trackstack'] = $pyjs['trackstack']['slice'](0,$pyjs__trackstack_size_1);
				$pyjs['track'] = $pyjs['trackstack']['slice'](-1)[0];
		...
		$m['rlecode_hqx'] = function(s) {
			...
			if ($p['bool']($p['op_eq'](s['__getitem__']((typeof ($usub6=$constant_int_1)=='number'?
				-$usub6:
				$p['op_usub']($usub6))), '!'))) {
			...
			while (typeof($p['__wrapped_next']($iter13_nextval)['$nextval']) != 'undefined') {
				...
				if ($p['bool'](($p['bool']($and40=$p['op_eq'](c, prev))?($p['cmp'](count, $constant_int_255) == -1):$and40))) {
					...
					else if ($p['bool'](($p['cmp'](count, $constant_int_4) == -1))) {
		...
		$m['rledecode_hqx'] = function(s) {
			...
			result = $p['list']([s['__getitem__']($constant_int_0)]);
			...
			while (typeof($p['__wrapped_next']($iter14_nextval)['$nextval']) != 'undefined') {
				...
				count = $p['ord'](snippet['__getitem__']($constant_int_0));
				$pyjs['track']['lineno']=655;
				if ($p['bool'](($p['cmp'](count, $constant_int_0) == 1))) {
					$pyjs['track']['lineno']=656;
					result['append']((typeof ($mul9=prev['__getitem__']((typeof ($usub7=$constant_int_1)=='number'?
						-$usub7:
		...
		$m['crc32'] = function(s, crc) {
			...
			while (typeof($p['__wrapped_next']($iter15_nextval)['$nextval']) != 'undefined') {
				...
				crc = $p['op_bitxor2']($m['crc_32_tab']['__getitem__']($p['op_bitand2']($p['op_bitxor2'](crc, $p['long']($p['ord'](c))), $constant_long_255)), $p['op_bitshiftright'](crc,$constant_int_8));
			...
			if ($p['bool'](($p['cmp'](result, (typeof ($pow1=$constant_int_2)==typeof ($pow2=$constant_int_31) && typeof $pow1=='number'?
				Math['pow']($pow1,$pow2):
		...
		$m['b2a_hex'] = function(s) {
			...
			while (typeof($p['__wrapped_next']($iter16_nextval)['$nextval']) != 'undefined') {
				...
				if ($p['bool'](($p['cmp'](c, $constant_int_9) == 1))) {
					$pyjs['track']['lineno']=739;
					c = $p['__op_sub']($sub31=$p['__op_add']($add107=c,$add108=$p['ord']('a')),$sub32=$constant_int_10);
				}
				else {
				...
				if ($p['bool'](($p['cmp'](c, $constant_int_9) == 1))) {
					...
					c = $p['__op_sub']($sub33=$p['__op_add']($add111=c,$add112=$p['ord']('a')),$sub34=$constant_int_10);
				}
				else {
		...
		$m['a2b_hex'] = function(t) {
			...
			pairs_gen = function(s) {
				...
				while ($p['bool'](s)) {
					...
					try {
						...
						iterlist['append']($p['tuple']([$m['table_hex']['__getitem__']($p['ord'](s['__getitem__']($constant_int_0))), $m['table_hex']['__getitem__']($p['ord'](s['__getitem__']($constant_int_1)))]));
					} catch($pyjs_try_err) {
						$pyjs['__last_exception_stack__'] = sys['save_exception_stack']($pyjs__trackstack_size_1 - 1);
						$pyjs['__active_exception_stack__'] = null;
						$pyjs_try_err = $p['_errorMapping']($pyjs_try_err);
			...
			while (typeof($p['__wrapped_next']($iter17_nextval)['$nextval']) != 'undefined') {
				var $tupleassign6 = $p['__ass_unpack']($iter17_nextval['$nextval'], 2, null);
				a = $tupleassign6[0];
				b = $tupleassign6[1];
				$pyjs['track']['lineno']=789;
				if ($p['bool'](($p['bool']($or29=($p['cmp'](a, $constant_int_0) == -1))?$or29:($p['cmp'](b, $constant_int_0) == -1)))) {
					$pyjs['track']['lineno']=790;
					$pyjs['__active_exception_stack__'] = null;
					throw ($p['TypeError']('Non-hexadecimal digit found'));
				}
				$pyjs['track']['lineno']=791;
				result['append']($p['chr']($p['__op_add']($add115=$p['op_bitshiftleft'](a,$constant_int_4),$add116=b)));
			}
			if ($pyjs['trackstack']['length'] > $pyjs__trackstack_size_1) {
				$pyjs['trackstack'] = $pyjs['trackstack']['slice'](0,$pyjs__trackstack_size_1);
				$pyjs['track'] = $pyjs['trackstack']['slice'](-1)[0];
