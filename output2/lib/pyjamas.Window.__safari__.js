...
$pyjs['loaded_modules']['pyjamas.Window'] = function (__mod_name__) {
	...
	try {
		...
		$m.__track_lines__[65] = 'pyjamas.Window.py, line 2:\n    # For the pyjamas/javascript version, see __browser__.pyjamas.Window ... def getDocumentRoot():';
