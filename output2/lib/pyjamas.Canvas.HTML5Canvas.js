...
$pyjs['loaded_modules']['pyjamas.Canvas.HTML5Canvas'] = function (__mod_name__) {
	...
	try {
		...
		$m.__track_lines__[20] = 'pyjamas.Canvas.HTML5Canvas.py, line 20:\n    class HTML5Canvas(GWTCanvas):';
		$m.__track_lines__[149] = 'pyjamas.Canvas.HTML5Canvas.py, line 149:\n    self.impl.setTextAlign(loc)';
		$m.__track_lines__[23] = 'pyjamas.Canvas.HTML5Canvas.py, line 23:\n    def getCanvasImpl(self):';
		$m.__track_lines__[24] = 'pyjamas.Canvas.HTML5Canvas.py, line 24:\n    return HTML5CanvasImplDefault()';
		...
		$m['HTML5Canvas'] = (function(){
			...
			$cls_definition['__md5__'] = '5c0b8f7b0c6f5b1a4efe0dc2fc9607c9';
			...
			$method = $pyjs__bind_method2('getCanvasImpl', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '5c0b8f7b0c6f5b1a4efe0dc2fc9607c9') {
				...
				$pyjs['track']['lineno']=24;
				var $pyjs__ret = $m['HTML5CanvasImplDefault']();
				$pyjs['trackstack']['pop']();$pyjs['track']=$pyjs['trackstack']['pop']();$pyjs['trackstack']['push']($pyjs['track']);
				return $pyjs__ret;
			}
	, 1, [null,null,['self']]);
