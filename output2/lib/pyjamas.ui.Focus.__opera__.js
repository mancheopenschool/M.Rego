...
$pyjs['loaded_modules']['pyjamas.ui.Focus'] = function (__mod_name__) {
	...
	try {
		...
		$m.__track_lines__[3] = 'pyjamas.ui.Focus.py, line 3:\n    #';
		...
		$m.__track_lines__[24] = 'pyjamas.ui.Focus.py, line 3:\n    # ... def ensureFocusHandler():';
		$m.__track_lines__[25] = 'pyjamas.ui.Focus.py, line 25:\n    pass';
		$m.__track_lines__[27] = 'pyjamas.ui.Focus.py, line 9:\n    # ... def createFocusHandler():';
		$m.__track_lines__[30] = 'pyjamas.ui.Focus.py, line 25:\n    pass ... def createFocusable0():';
		...
		$m.__track_lines__[46] = 'pyjamas.ui.Focus.py, line 46:\n    ';
    ...
    return div;
		...
		$m['createFocusable'] = function() {
			...
			$pyjs['track']['lineno']=46;
			var $pyjs__ret = $m['createFocusable0']($m['ensureFocusHandler']());
			$pyjs['trackstack']['pop']();$pyjs['track']=$pyjs['trackstack']['pop']();$pyjs['trackstack']['push']($pyjs['track']);
			return $pyjs__ret;
		};
