...
$pyjs['loaded_modules']['pyjamas.Canvas.GWTCanvas'] = function (__mod_name__) {
	...
	try {
		...
		$m.__track_lines__[44] = 'pyjamas.Canvas.GWTCanvas.py, line 44:\n    class GWTCanvas(FocusWidget):';
		...
		$m.__track_lines__[84] = 'pyjamas.Canvas.GWTCanvas.py, line 84:\n    def getCanvasImpl(self):';
		$m.__track_lines__[85] = 'pyjamas.Canvas.GWTCanvas.py, line 85:\n    return GWTCanvasImplDefault()';
		...
		$m.__track_lines__[143] = 'pyjamas.Canvas.GWTCanvas.py, line 143:\n    def createLinearGradient(self, x0, y0, x1, y1):';
		$m.__track_lines__[144] = 'pyjamas.Canvas.GWTCanvas.py, line 144:\n    return LinearGradientImplDefault(x0, y0, x1, y1, self.getCanvasElement())';
		...
		$m.__track_lines__[159] = 'pyjamas.Canvas.GWTCanvas.py, line 159:\n    def createRadialGradient(self, x0, y0, r0, x1, y1, r1):';
		$m.__track_lines__[160] = 'pyjamas.Canvas.GWTCanvas.py, line 160:\n    return RadialGradientImplDefault(x0, y0, r0, x1, y1, r1,';
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('getCanvasImpl', function() {
				...
				$pyjs['track']['lineno']=85;
				var $pyjs__ret = $m['GWTCanvasImplDefault']();
				$pyjs['trackstack']['pop']();$pyjs['track']=$pyjs['trackstack']['pop']();$pyjs['trackstack']['push']($pyjs['track']);
				return $pyjs__ret;
			}
	, 1, [null,null,['self']]);
	...
	, 1, [null,null,['self']]);
			...
			$method = $pyjs__bind_method2('createLinearGradient', function(x0, y0, x1, y1) {
				...
				$pyjs['track']['lineno']=144;
				var $pyjs__ret = $m['LinearGradientImplDefault'](x0, y0, x1, y1, self['getCanvasElement']());
				$pyjs['trackstack']['pop']();$pyjs['track']=$pyjs['trackstack']['pop']();$pyjs['trackstack']['push']($pyjs['track']);
				return $pyjs__ret;
			}
	, 1, [null,null,['self'],['x0'],['y0'],['x1'],['y1']]);
			...
			$method = $pyjs__bind_method2('createRadialGradient', function(x0, y0, r0, x1, y1, r1) {
				...
				$pyjs['track']['lineno']=160;
				var $pyjs__ret = $m['RadialGradientImplDefault'](x0, y0, r0, x1, y1, r1, self['getCanvasElement']());
				$pyjs['trackstack']['pop']();$pyjs['track']=$pyjs['trackstack']['pop']();$pyjs['trackstack']['push']($pyjs['track']);
				return $pyjs__ret;
			}
