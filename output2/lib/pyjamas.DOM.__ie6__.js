...
$pyjs['loaded_modules']['pyjamas.DOM'] = function (__mod_name__) {
	...
	try {
		...
		$m.__track_lines__[241] = 'pyjamas.DOM.py, line 44:\n    ONLOAD, ... def compare(elem1, elem2):';
		...
		$m.__track_lines__[297] = 'pyjamas.DOM.py, line 53:\n    ) ... def createInputRadio(group):';
		...
		$m.__track_lines__[351] = 'pyjamas.DOM.py, line 237:\n    False, False, False, 0, element) ... def eventStopPropagation(evt):';
		...
		$m.__track_lines__[406] = 'pyjamas.DOM.py, line 72:\n    elif listener is None: ... def eventGetCurrentTarget(event):';
		$m.__track_lines__[410] = 'pyjamas.DOM.py, line 75:\n    listeners[hash(item)] = listener ... def eventGetTarget(event):';
		$m.__track_lines__[414] = 'pyjamas.DOM.py, line 81:\n    def init(): ... def eventGetToElement(evt):';
		$m.__track_lines__[423] = 'pyjamas.DOM.py, line 66:\n    return ret ... def eventGetType(event):';
		...
		$m.__track_lines__[434] = 'pyjamas.DOM.py, line 86:\n    mf._addWindowEventListener("mousedown", browser_event_cb) ... def eventPreventDefault(evt):';
		...
		$m.__track_lines__[442] = 'pyjamas.DOM.py, line 91:\n    mf._addWindowEventListener("keypress", browser_event_cb) ... def eventToString(evt):';
		$m.__track_lines__[446] = 'pyjamas.DOM.py, line 446:\n    def iframeGetSrc(elem):';
		$m.__track_lines__[447] = 'pyjamas.DOM.py, line 447:\n    return elem.src';
		$m.__track_lines__[450] = 'pyjamas.DOM.py, line 107:\n    def _dispatchWindowEvent(sender, evt, useCap): ... def getAbsoluteLeft(elem):';
		$m.__track_lines__[464] = 'pyjamas.DOM.py, line 121:\n    listener = None ... def getAbsoluteTop(elem):';
		...
		$m.__track_lines__[503] = 'pyjamas.DOM.py, line 188:\n    except: ... def getCaptureElement():';
		$m.__track_lines__[508] = 'pyjamas.DOM.py, line 138:\n     ... def getChild(elem, index):';
		...
		$m.__track_lines__[594] = 'pyjamas.DOM.py, line 277:\n     ... def getInnerHTML(element):';
		$m.__track_lines__[601] = 'pyjamas.DOM.py, line 165:\n    #print "synthesise", cap ... def getInnerText(element):';
		...
		$m.__track_lines__[636] = 'pyjamas.DOM.py, line 171:\n    return ... def getNextSibling(elem):';
		$m.__track_lines__[643] = 'pyjamas.DOM.py, line 643:\n    def getNodeType(elem):';
		$m.__track_lines__[644] = 'pyjamas.DOM.py, line 644:\n    return elem.nodeType';
		$m.__track_lines__[647] = 'pyjamas.DOM.py, line 177:\n     ... def getParent(elem):';
		$m.__track_lines__[656] = 'pyjamas.DOM.py, line 336:\n    return createElement("td") ... def getStyleAttribute(elem, attr):';
		$m.__track_lines__[667] = 'pyjamas.DOM.py, line 183:\n    if event is None: ... def insertChild(parent, toAdd, index):';
		...
		$m.__track_lines__[766] = 'pyjamas.DOM.py, line 203:\n    else: ... def isOrHasChild(parent, child):';
		...
		$m.__track_lines__[787] = 'pyjamas.DOM.py, line 214:\n    return True ... def releaseCapture_impl(elem): pass';
		...
		$m.__track_lines__[872] = 'pyjamas.DOM.py, line 219:\n     ... def setCapture_impl(elem): pass';
		...
		$m.__track_lines__[895] = 'pyjamas.DOM.py, line 224:\n     ... def setInnerText(elem, text):';
		...
		$m.__track_lines__[979] = 'pyjamas.DOM.py, line 232:\n     ... def toString(elem):';
		...
		$m.__track_lines__[1035] = 'pyjamas.DOM.py, line 191:\n    #print "browser_event_cb", event ... def insertListItem(select, item, value, index):';
		$m.__track_lines__[1046] = 'pyjamas.DOM.py, line 97:\n    mf._addEventListener(body, "change", cb) ... def getBodyOffsetTop():';
		$m.__track_lines__[1050] = 'pyjamas.DOM.py, line 102:\n    mf._addEventListener(body, "resize", cb) ... def getBodyOffsetLeft():';
		$m.__track_lines__[1053] = 'pyjamas.DOM.py, line 240:\n     ... def eventGetMouseWheelVelocityY(evt):';
