...
$pyjs['loaded_modules']['pyjamas.ui.RootPanel'] = function (__mod_name__) {
	...
	, 1, [null,null,['self']]);
		...
		$m['get'] = function(id) {
			...
			$pyjs['track']['lineno']=48;
			var $pyjs__ret = (typeof manageRootPanel == "undefined"?$m['manageRootPanel']:manageRootPanel)((typeof RootPanelCls == "undefined"?$m['RootPanelCls']:RootPanelCls)(element), id);
			$pyjs['trackstack']['pop']();$pyjs['track']=$pyjs['trackstack']['pop']();$pyjs['trackstack']['push']($pyjs['track']);
			return $pyjs__ret;
		};
		$m['get']['__name__'] = 'get';
