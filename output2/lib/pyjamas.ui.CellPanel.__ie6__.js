...
$pyjs['loaded_modules']['pyjamas.ui.CellPanel'] = function (__mod_name__) {
	...
	try {
		...
		$m.__track_lines__[4] = 'pyjamas.ui.CellPanel.py, line 4:\n    # Licensed under the Apache License, Version 2.0 (the "License");';
		$m.__track_lines__[5] = 'pyjamas.ui.CellPanel.py, line 5:\n    # you may not use this file except in compliance with the License.';
		$m.__track_lines__[7] = 'pyjamas.ui.CellPanel.py, line 7:\n    #';
		...
		$m.__track_lines__[23] = 'pyjamas.ui.CellPanel.py, line 4:\n    # Licensed under the Apache License, Version 2.0 (the "License"); ... class CellPanel(ComplexPanel):';
		...
		$m.__track_lines__[98] = 'pyjamas.ui.CellPanel.py, line 4:\n    # Licensed under the Apache License, Version 2.0 (the "License"); ... def setBorderWidth(self, width):';
		...
		$m['CellPanel'] = (function(){
			...
			$cls_definition['__md5__'] = 'df7e3d9ace791d482cab490f02d67f7d';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== 'df7e3d9ace791d482cab490f02d67f7d') {
