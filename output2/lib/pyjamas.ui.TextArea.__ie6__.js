...
$pyjs['loaded_modules']['pyjamas.ui.TextArea'] = function (__mod_name__) {
	...
	try {
		...
		$m.__track_lines__[3] = 'pyjamas.ui.TextArea.py, line 3:\n    #';
		...
		$m.__track_lines__[21] = 'pyjamas.ui.TextArea.py, line 3:\n    # ... class TextArea(TextBoxBase):';
		...
		$m.__track_lines__[44] = 'pyjamas.ui.TextArea.py, line 3:\n    # ... def getCursorPos(self):';
		...
		$m['TextArea'] = (function(){
			...
			$cls_definition['__md5__'] = '9d543d24a9bb24b7a92f6038115b8de1';
			...
			$method = $pyjs__bind_method2('__init__', function() {
				...
				if ($pyjs['options']['arg_instance_type']) {
					if (self.prototype['__md5__'] !== '9d543d24a9bb24b7a92f6038115b8de1') {
